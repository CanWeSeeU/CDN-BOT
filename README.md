...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/CanWeSeeU/CDN-BOT/main/install.sh)
```

or

```bash
wget -qO- https://raw.githubusercontent.com/CanWeSeeU/CDN-BOT/main/install.sh | bash
```
